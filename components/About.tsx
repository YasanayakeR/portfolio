        ...
        >
          ...
          <div className="order-2 md:order-1">
            ...
            <div className="space-y-6 text-slate-300 leading-relaxed mb-8">
              <p>
                Innovative and driven full stack developer passionate about
                building end-to-end web applications. Skilled in both frontend
                and backend technologies, thriving in collaborative environments
                and eager to contribute to impactful projects while learning
                from experienced professionals.
              </p>
              <p>
                Seeking a full stack development internship to apply skills,
                expand expertise, and contribute to cutting-edge solutions.
              </p>
            </div>
